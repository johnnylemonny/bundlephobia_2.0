...
import { NodesAnimation } from '../client/components/NodesAnimation/NodesAnimation'
...
import { GlobalRecentSearches } from '../client/components/GlobalRecentSearches/GlobalRecentSearches'
...
if (typeof window !== 'undefined') {
  console.log('Index Components Debug:', {
    ...
    GlobalRecentSearches: typeof GlobalRecentSearches,
  })
}
...
const Logo = () => (
  ...
  >
    ...
    >
      ...
      <g className="logo__skeleton-group" transform="translate(104.153 25.807)">
      ...
      <path className="logo__skeleton" d="M104.97 112.06l10.7 2.98" />
      <g
      ...
      <path className="logo__skeleton" d="M32.4 112.06l-10.7 2.98" />
      ...
      <g className="logo__skeleton-group" transform="translate(23.263 1.5)">
    ...
    <Layout className="homepage">
      ...
      <div className="homepage__container">
        ...
        <div className="homepage__content">
          ...
          <div className="homepage__searches-container">
